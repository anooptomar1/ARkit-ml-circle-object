...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Setup Vision Model
        guard let selectedModel = try? VNCoreMLModel(for: circle().model) else {
    ...
    func classificationCompleteHandler(request: VNRequest, error: Error?) {
        ...
        // Get Classifications
        let classifications = observations[0...1] // 2 results
        ...
        DispatchQueue.main.async {
            ...
            self.debugTextView.text = "circle probabilities: \n" + classifications
            
            // Display Top Symbol0
            var symbol = "no circle"
            ...
            if (topPredictionScore != nil && topPredictionScore! > 0.01) {
                ...
                if (topPredictionName == "circle") { symbol = "circle" }
                if (topPredictionName == "no circle ") { symbol = "no circle" }
            }
